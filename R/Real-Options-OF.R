...
#'
#' \bold{Operational Flexibilities:}
#'
#' Operational flexibilities are adjustments made to a project in response to, or anticipation of, positive or negative economic outcomes
#' that occur after a project has begun. Operational flexibilities have the ability to mitigate the effect of poor timing of initial
#' investment by maximizing gains and minimizing losses. Operational flexibilities that reduce losses in response to negative economic
...
#' values near zero.
#'
#' The operational flexibilties supported by the \code{LSM.RealOption.OF} function are the ability to temporarily suspend and permanently
...
#' flexibilities, there are several different "states" or operating modes available for an investment project. These are:
#'
#' * Not yet invested
#' * Operational
#' * Suspended
...
#'
#' Solving for the value of an investment project with operational flexibilities is classified as an optimal switching or optimal control
...
#'
#' The introduction of operational flexibilities to the LSM simulation method greatly increases the level of computational complexity and thus the
...
#' \code{NPV + OF} \tab Net present Value + operational flexibilities. The value immediate investment into an investment project when actively managing and appropriately exercising operational flexibilities \cr
